    ...
    <script>
        $(function () {
                    ...
                    $.ajax({
                        ...
                        success:function (data) {
                            ...
                            if(data.status=="200"){
                                ...
                                //登陆失败 展示错误信息
                                $("#message").html("<span style='color: #761c19'><strong>"+data.message+"</strong></span>")
                            }
                        }
                    })
                }
            ...
            $.extend($.validator.messages, {
                required: "<span style = 'color: #761c19'>必填字段,请正确填写</span>",
                minlength: $.validator.format("<span style='color: #761c19'>长度不足,请重新填写</span>")
            });

            /*点击刷新验证码*/
            $("#captchaImage").click(function(){
                $("#captchaImage").prop("src","${path}/imageCode/getImageCode?"+new Date().getTime());
            });
        })
    </script>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    <h1><strong>应学</strong> Login Form</h1>
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="username" placeholder="请输入用户名..." minlength="2" class="form-username form-control" required id="form-username">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="form-password">Password</label>
                                <input type="password" name="password" placeholder="请输入密码..." minlength="6" class="form-password form-control" required id="form-password">
                            </div>
                            <div class="form-group">
                                <%--<label class="sr-only" for="form-code">Code</label>--%>
                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${path}/imageCode/getImageCode">
                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" minlength="4" maxlength="4" required type="test" name="enCode" id="form-code">
                            </div>
